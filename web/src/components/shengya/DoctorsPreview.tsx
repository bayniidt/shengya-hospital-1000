...
export function DoctorsPreview() {
  ...
  return <section className="sy-section sy-doctors" data-reveal>
    <div className="sy-container">
      <div className="sy-section-heading sy-doctors-heading">
        <div><p className="sy-kicker">OUR DOCTORS</p><h2>{text('专业团队，悉心相伴', 'Expert care, every step of the way')}</h2></div>
